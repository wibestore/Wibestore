        ...
        <div className="bt min-h-screen pt-24 pb-16 page-enter">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="bs text-center mb-12">
                    <div className="za inline-flex items-center px-5 py-2.5 bg-orange-500/10 border border-orange-500/30 rounded-full text-orange-400 text-sm font-medium" style={{ gap: '10px', marginBottom: '24px' }}>
                ...
                <div className="bs grid grid-cols-1 sm:grid-cols-3 gap-4 mb-12">
                    ...
                    <div className="height-w bg-gradient-to-b from-[#1e1e32] to-[#25253a] rounded-2xl p-6 border border-white/5 text-center">
                        ...
                        <div className="text-2xl font-bold text-gray-800 mb-1">4.5+ Reyting</div>
                        <div className="text-gray-400 text-sm">Faqat yuqori baholanganlar</div>
                    </div>
                    <div className="height-w bg-gradient-to-b from-[#1e1e32] to-[#25253a] rounded-2xl p-6 border border-white/5 text-center">
                        <Flame className="w-8 h-8 text-orange-400 mx-auto mb-3" />
                        <div className="text-2xl font-bold text-gray-800 mb-1">100+ Sotuvlar</div>
