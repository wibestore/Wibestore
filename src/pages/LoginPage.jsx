            ...
            <div className="w-full max-w-md px-4">
                ...
                <div className="bg-[#1e1e32] rounded-2xl p-8 border border-white/5">
                    ...
                    <div className="space-y-3">
                        <button className="w-full flex items-center justify-center gap-3 py-3 bg-[#25253a] border border-white/10 rounded-xl text-white hover:bg-[#2a2a45] transition-colors">
