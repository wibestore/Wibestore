    ...
    return (
        <div className="space-y-6">
            <div>
                ...
                <p className="text-gray-400">Xush kelibsiz, Admin!</p>
            </div>

            {/* Stats Grid */}
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                {stats.map((stat, index) => (
                    <div key={index} className="bg-[#1e1e32] rounded-2xl p-6 border border-white/5">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div className="bg-[#1e1e32] rounded-2xl border border-white/5 overflow-hidden">
                    <div className="p-6 border-b border-white/5">
                        <h2 className="text-lg font-semibold text-white">So'nggi akkauntlar</h2>
                    </div>
                                ...
                                {recentAccounts.map((account) => (
                                    <tr key={account.id} className="border-b border-white/5 last:border-0">
                                        <td className="p-4">
                                            ...
                                            <div className="text-xs text-gray-500">{account.seller}</div>
                                        </td>
                                        ...
                                        <td className="p-4">
                                            <div className="flex items-center gap-2">
                                                ...
                                                {account.status === 'pending' && (
                                                    <>
                                                        <button className="p-1.5 text-green-400 hover:bg-green-500/20 rounded-lg transition-colors">
                ...
                <div className="bg-[#1e1e32] rounded-2xl border border-white/5 overflow-hidden">
                    <div className="p-6 border-b border-white/5">
                        <h2 className="text-lg font-semibold text-white">So'nggi shikoyatlar</h2>
                    </div>
                    <div className="p-4 space-y-4">
                        {recentReports.map((report) => (
                            <div key={report.id} className="flex items-center justify-between p-4 bg-[#25253a] rounded-xl">
                                <div>
                                    <div className="flex items-center gap-2 mb-1">
                                        <AlertTriangle className="w-4 h-4 text-red-400" />
                                        <span className="font-medium text-white text-sm">{report.type}</span>
                                    </div>
                                    <div className="text-xs text-gray-400">{report.account}</div>
                                    <div className="text-xs text-gray-500">Reporter: {report.reporter}</div>
                                </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
                <div className="bg-gradient-to-r from-purple-500/20 to-pink-500/20 rounded-2xl p-6 border border-purple-500/20">
                    <div className="flex items-center gap-3 mb-4">
                        ...
                        <div>
                            ...
                            <div className="text-sm text-gray-400">Jami foydalanuvchilar</div>
                        </div>
                    </div>
                    <div className="text-sm text-purple-300">Bugun +45 ta yangi</div>
                </div>
                ...
                <div className="bg-gradient-to-r from-yellow-500/20 to-orange-500/20 rounded-2xl p-6 border border-yellow-500/20">
                    <div className="flex items-center gap-3 mb-4">
                        ...
                        <div>
                            ...
                            <div className="text-sm text-gray-400">Premium obunalar</div>
                        </div>
                    </div>
                    <div className="text-sm text-yellow-300">Oylik: {formatPrice(33858000)}</div>
                </div>
                ...
                <div className="bg-gradient-to-r from-green-500/20 to-emerald-500/20 rounded-2xl p-6 border border-green-500/20">
                    <div className="flex items-center gap-3 mb-4">
                        ...
                        <div>
                            <div className="text-2xl font-bold text-white">{formatPrice(156000000)}</div>
                            <div className="text-sm text-gray-400">Oylik daromad</div>
                        </div>
                    </div>
                    <div className="text-sm text-green-300">Komissiyadan: {formatPrice(15600000)}</div>
                </div>
            </div>
        </div>
    );
